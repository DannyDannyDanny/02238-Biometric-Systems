...
def create_base_network(input_shape):
    ...
    # x = Conv2D(96, (7,7),padding='valid',activation='relu',input_shape=input_shape)(input)
    x = Conv2D(64, kernel_size=(3,3), activation='relu', input_shape=input_shape)(input)
    x = Flatten()(x)
...
for i in range(1):
    ...
    history = model.fit([tr_pairs[:, 0], tr_pairs[:, 1]], tr_y,
              batch_size=32,
              epochs=25,#epochs,
              validation_data=([te_pairs[:, 0], te_pairs[:, 1]], te_y),verbose=0)
